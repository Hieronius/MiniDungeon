					...
					Button(
						action: {
							...
							if viewModel.gameState.didFlaskGetLevelUP && viewModel.gameState.currentGameScreen != .battle {
								...
								// MARK: Sound Testing
								viewModel.audioManager.playSound(fileName: "flaskModeSwitch", extensionName: "mp3")
							}
						},
						label: {
//							Image(viewModel.gameState.hero.flask.battleMode == .offensive ? "offensiveFlask" : "defensiveFlask")

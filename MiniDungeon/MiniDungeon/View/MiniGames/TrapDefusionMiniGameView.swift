...
/*
 MARK: Guide:
 - You can add more arrows such as arrow.diagonalLeft/Right to increase difficulty
 - Refactor code to avoid redundant button settings
...
extension MainView.TrapDefusionMiniGameView {
